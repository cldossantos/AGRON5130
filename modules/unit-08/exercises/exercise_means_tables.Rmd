---
title: "Exercise: Means Tables"
output: html_document
---

# Introduction

This exercise focuses on an essential skill that
is often overlooked: how to present means in a
clear, publication-ready format.

You will use R to organize treatment means,
include supporting statistics (SED and reps), and
format a final table that is suitable for reports
or presentations.
