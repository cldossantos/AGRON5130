...
- [ ] What requirements will be needed for RStudio Cloud?
...
- [ ] Could you please verify that the accessibility and privacy links are correct?
...
- [ ] Caio Please review and let us know if there is anything you want added or removed

##  Office Hours
- [ ]  Caio Edit the page
- [ ] The schedule section may still reflect Dr. Harbur’s information


## Module: Video Introduction to Working with RStudio Cloud
- [ ] Caio Review pages
- [ ] Headings and short preview paragraphs were added for each video

## Module 1: Basic Principles
- [ ]  Caio Read and edit
- [ ]  "Completion Requirements" Section: was added to explain how materials help students complete assessments (for reviewers) - Please look over
You will need to write this for the other modules for the QM review

## DT 1.1 (Discussion) 
- [ ] Caio Edit
- [ ] Grading criteria/rubric added — please edit as you would like (QM requires either a checklist for grading or a rubric, but you do not have to have both) 
- [ ] When finalized, we can show you how to attach a rubric to SpeedGrader if you want
- [ ] AI policy added
- [ ] Can be adjusted to whatever you want
Do you have a specific rubric or grading criteria that you want applied to all DT? 

## Module 1 Video Pages
 - [ ] All video pages have had headings and introductory paragraphs added
 - [ ] Caio please review

##Assignment 1.1
- [ ]  Caio Edit
- [ ]  Grading criteria added — edit as you wish  (QM requires either a checklist for grading or a rubric, but you do not have to have both) 
- [ ]  AI policy added
- [ ]  Can be adjusted to whatever you want
- [ ]  This can be set so that no one can submit work to Canvas, if you prefer
Do you have a specific rubric or grading criteria that you want applied to all assignments? 
Team Reminder to Discuss Jan 6th with Todd:
- [ ] Question to discuss with Todd:
Will reviewers need to create accounts in RStudio to view assignments?
How will reviewers see and evaluate RStudio assignments?


## Module 1 Reflection
- [ ] Caio Read and edit
- [ ] Review grading criteria
Do you have a specific rubric or grading criteria that you want applied to all reflections? 
Team Reminder to Discuss Jan 6 with Todd:
- [ ] Will these assessments need to be moved to New Quizzes? 
- [ ] Talk with Todd about next steps
